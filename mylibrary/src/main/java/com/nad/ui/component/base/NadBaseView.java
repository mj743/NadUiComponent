...
public abstract class NadBaseView extends View {
    ...
    public NadBaseView(Context context) {
        super(context);
        init(context, null);
    }

    public NadBaseView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NadBaseView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
