...
public class NadGlowConstraintLayout extends NadBaseConstraintLayout {

    public NadGlowConstraintLayout(@NonNull Context context) {
        super(context);
    }

    public NadGlowConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NadGlowConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
