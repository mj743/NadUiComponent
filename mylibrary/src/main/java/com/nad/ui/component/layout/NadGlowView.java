...
public class NadGlowView extends NadBaseView {

    public NadGlowView(@NonNull Context context) {
        super(context);
    }

    public NadGlowView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NadGlowView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
