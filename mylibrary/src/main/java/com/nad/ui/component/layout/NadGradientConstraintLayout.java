...
import com.nad.ui.component.base.NadBaseConstraintLayout;

public class NadGradientConstraintLayout extends NadBaseConstraintLayout {

    private int strokeDirection = 0;

    public NadGradientConstraintLayout(@NonNull Context context) {
        super(context);
    }

    public NadGradientConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NadGradientConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
