...
import com.nad.ui.component.base.NadBaseView;

public class NadGradientView extends NadBaseView {

    private int strokeDirection = 0;

    public NadGradientView(@NonNull Context context) {
        super(context);
    }

    public NadGradientView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NadGradientView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
